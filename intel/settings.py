...
ALLOWED_HOSTS = [
    '127.0.0.1',
    'kyekyeku-ezu4j.ondigitalocean.app',
    'www.kyekyeku-tech.site'
]
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Kyekyeku Tech",
    "site_header": "Kyekyeku Tech",
    # "site_logo": "img/site/bestPay Logo.png",
    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Kyekyeku Tech",
    "copyright": "Kyekyeku Tech",
    # "login_logo": "img/site/bp.png",
    "welcome_sign": "Welcome to the Kyekyeku Tech Admin",
